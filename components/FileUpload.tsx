  ...
  return (
    <div>
      ...
      <label
        ...
        onDrop={handleDrop}
        className={`flex justify-center w-full h-32 px-4 transition bg-gray-700/50 border-2 ${isDragging ? 'border-raceRed-400' : 'border-gray-600'} border-dashed rounded-md appearance-none cursor-pointer hover:border-gray-500 focus:outline-none`}
      >
        <span className="flex items-center space-x-2">
            ...
            <span className="font-medium text-gray-400">
                ...
                <span className="text-raceRed-400 underline ml-1">browse</span>
            </span>
        </span>
